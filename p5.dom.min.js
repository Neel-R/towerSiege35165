...
!function (t, e) {
    "function" == typeof define && define.amd ? define("p5.dom", ["p5"], function (t) { e(t) }) : "object" == typeof exports ? e(require("../p5")) : e(t.p5)
}(this, function (d) {
    function l(t) { var e = document; return "string" == typeof t && "#" === t[0] ? (t = t.slice(1), e = document.getElementById(t) || document) : t instanceof d.Element ? e = t.elt : t instanceof HTMLElement && (e = t), e }

    function c(t, e, i) {
        (e._userNode ? e._userNode : document.body).appendChild(t); var n = i ? new d.MediaElement(t, e) : new d.Element(t, e); return e._elements.push(n), n
    } d.prototype.select =
        function (t, e) {
            d._validateParameters("select", arguments); var i = null, n = l(e);
        ...
        }, d.prototype.selectAll =
        function (t, e) {
            d._validateParameters("selectAll", arguments); var i, n = [], r = l(e); if (i = "." === t[0] ? (t = t.slice(1), r.getElementsByClassName(t)) : r.getElementsByTagName(t)) for (var o = 0; o < i.length; o++) {
                var s = this._wrapElement(i[o]); n.push(s)
            }
            return n
        }
        , d.prototype._wrapElement = function (t) {
            var e = Array.prototype.slice.call(t.children); if ("INPUT" !== t.tagName || "checkbox" !== t.type) return "VIDEO" === t.tagName || "AUDIO" === t.tagName ? new d.MediaElement(t, this) : "SELECT" === t.tagName ? this.createSelect(new d.Element(t, this)) : 0 < e.length && e.every(function (t) { return "INPUT" === t.tagName || "LABEL" === t.tagName }) ? this.createRadio(new d.Element(t, this)) : new d.Element(t, this); var i = new d.Element(t, this); return i.checked = function () { return 0 === arguments.length ? this.elt.checked : (arguments[0] ? this.elt.checked = !0 : this.elt.checked = !1, this) }, i
        }
        , d.prototype.removeElements = function (t) {
            d._validateParameters("removeElements", arguments); for (var e = 0; e < this._elements.length; e++)this._elements[e].elt instanceof HTMLCanvasElement || this._elements[e].remove()
        }
        , d.Element.prototype.changed =
        function (t) {
    ...
    function i(t, e, i, n) {
        ...
        "string" == typeof (i = i || "") && (i = [i]); for (var o = 0; o < i.length; o++) {

            var s = document.createElement("source");
            s.src = i[o], r.appendChild(s)
        } if (void 0 !== n) {
            var l = function () { n(), r.removeEventListener("canplaythrough", l) };
            r.addEventListener("canplaythrough", l)
        }
        var a = c(r, t, !0); return a.loadedmetadata = !1, r.addEventListener("loadedmetadata",
            function () {
    ...
    ["div", "p", "span"].forEach
        ...
        }), d.prototype.createImg =
        function () {
            d._validateParameters("createImg", arguments); var t = document.createElement("img"); t.crossOrigin = "Anonymous"; var e, i = arguments; return t.src = i[0], 1 < i.length && "string" == typeof i[1] && (t.alt = i[1]), t.onload = function () { e.width = t.offsetWidth || t.width, e.height = t.offsetHeight || t.height, 1 < i.length && "function" == typeof i[1] ? (e.fn = i[1], e.fn()) : 1 < i.length && "function" == typeof i[2] && (e.fn = i[2], e.fn()) }, e = c(t, this)
        }, d.prototype.createA =
        function (t, e, i) {
        ...
        , d.prototype.createButton =
        function (t, e) {
            d._validateParameters("createButton", arguments); var i = document.createElement("button"); return i.innerHTML = t, e && (i.value = e), c(i, this)
        }, d.prototype.createCheckbox = function () {
            d._validateParameters("createCheckbox", arguments); var t = document.createElement("div"), e = document.createElement("input");
            e.type = "checkbox", t.appendChild(e);
            var i = c(t, this); if (i.checked = function () {
                ...
                , arguments[0]) {
                var n = Math.random().toString(36).slice(2), r = document.createElement("label");
